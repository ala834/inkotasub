        ...
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding:32px;">
              <p style="margin:0 0 20px;font-size:15px;color:#18181b;line-height:1.6;">Hi <strong>${userName}</strong>,</p>
              <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6;">
                ${isWallet ? "Your wallet has been funded successfully." : "Your transaction has been completed successfully."}
              </p>
                ...
                <tr>
                  <td style="padding:20px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ${detailRows}
                      <tr><td colspan="2" style="padding:12px 0 4px;"><hr style="border:none;border-top:1px dashed #d4d4d8;margin:0;"/></td></tr>
                      <tr>
              ...
              <p style="margin:0;font-size:13px;color:#a1a1aa;line-height:1.5;">
                This is an automated receipt. If you did not authorize this, please contact support immediately.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:20px 32px;background-color:#fafafa;border-top:1px solid #e4e4e7;">
              <p style="margin:0;font-size:12px;color:#a1a1aa;text-align:center;">© ${year} INKOTA SUB. All rights reserved.</p>
            </td>
          </tr>
        </table>
      </td>
...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Receipt email result:", JSON.stringify(result));

    return new Response(
      JSON.stringify({ success: true, sent: result.success, testMode: result.testMode }),
      { headers: { ...corsHeaders, "Content-Type": "application/json" } }
    );
  } catch (error) {
